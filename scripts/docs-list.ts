...
// @ts-nocheck
/**
 * List all markdown files in docs/ with their frontmatter metadata
 * Adapted from steipete/agent-scripts
 * 
 * Note: This is a standalone Node.js script run with tsx, not part of the TypeScript project.
 * The node: imports are valid for Node.js 16+ but may show IDE errors.
 */
...
const EXCLUDED_DIRS = new Set(['archive', 'research', '.git']);
