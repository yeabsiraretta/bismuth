...
export const BISMUTH_COMPONENTS: ComponentDefinition[] = [
  ...
  // ── Sidebar vertical tab bar ───────────────────────────────────────────────
  {
    ...
    elements: [
      ...
      ...[0, 1, 2, 3, 4].map((i) => ({
        ...
        rotation: 0,
        properties: {
          fill: i === 0 ? 'var(--background-modifier-hover)' : 'transparent',
          radius: 6,
        },
        layer_id: 'default',
        z_index: 1,
  ...
  // ── Panel header ──────────────────────────────────────────────────────────
  {
    ...
    exposedProps: [{ key: 'title', label: 'Title', type: 'text', defaultValue: 'Panel Title' }],
    width: 280,
    height: 36,
  ...
  // ── Note editor toolbar ────────────────────────────────────────────────────
  {
    ...
    elements: [
      ...
      ...[
        ...
        rotation: 0,
        properties: {
          fill: label === 'Source' ? 'var(--background-modifier-hover)' : 'transparent',
          radius: 4,
          stroke: label === 'Source' ? 'var(--border-color)' : 'transparent',
          strokeWidth: 1,
        },
        layer_id: 'default',
        z_index: 1,
  ...
  // ── Status bar ─────────────────────────────────────────────────────────────
  {
    ...
    elements: [
      ...
      },
      {
        ...
        rotation: 0,
        properties: {
          text: '1,234 words  •  6 lines  •  Saved',
          fontSize: 11,
          fill: 'var(--text-muted)',
          textAlign: 'right',
        },
  ...
  // ── Toast notification ─────────────────────────────────────────────────────
  {
    ...
    elements: [
      ...
      },
      {
        ...
        rotation: 0,
        properties: {
          text: 'Toast message text goes here',
          fontSize: 13,
          fill: 'var(--text-normal)',
          textAlign: 'left',
          lineHeight: 1.4,
    ...
    exposedProps: [
      { key: 'message', label: 'Message', type: 'text', defaultValue: 'Toast message text' },
    ],
    width: 320,
    height: 52,
