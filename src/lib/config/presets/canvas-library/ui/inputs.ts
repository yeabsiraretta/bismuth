...
export const INPUT_COMPONENTS: ComponentDefinition[] = [
    ...
    elements: [
      {
        ...
        rotation: 0,
        properties: {
          fill: 'var(--background-modifier-form-field)',
  ...
  },
  {
    ...
    elements: [
      ...
      },
      {
        ...
        height: 20,
        rotation: 0,
        properties: { text: '[search]', fontSize: 14, fill: 'var(--text-muted)' },
        layer_id: 'default',
        z_index: 1,
        locked: false,
        visible: true,
  ...
  {
    id: 'builtin-input-textarea',
    name: 'Textarea',
    category: 'Inputs',
    icon: 'edit',
    width: 240,
    height: 100,
    tags: ['input', 'form', 'textarea'],
    isBuiltin: true,
    exposedProps: [
      {
        key: 'placeholder',
  ...
  },
  {
    ...
    elements: [
      ...
      },
      {
        ...
        height: 18,
        rotation: 0,
        properties: { text: 'Option', fontSize: 14, fill: 'var(--text-normal)', textAlign: 'left' },
        layer_id: 'default',
        z_index: 1,
        locked: false,
        visible: true,
  ...
  {
    id: 'builtin-input-toggle',
    name: 'Toggle Switch',
    category: 'Inputs',
    icon: 'toggle-left',
    width: 44,
    height: 24,
    tags: ['input', 'form', 'toggle', 'switch'],
    isBuiltin: true,
    ...
    elements: [
      {
        ...
        height: 24,
        rotation: 0,
        properties: { fill: 'var(--background-modifier-border)', radius: 12 },
        layer_id: 'default',
        z_index: 0,
        locked: false,
        visible: true,
