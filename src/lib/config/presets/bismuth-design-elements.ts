...
function textEl(
  ...
  x: number,
  y: number,
  opts: Partial<{ fontSize: number; fontWeight: number; fill: string; width: number }> = {}
): CanvasElement {
  return {
    id,
    element_type: 'text',
...
function rect(
  ...
  h: number,
  fill: string,
  opts: Partial<{ stroke: string; radius: number; opacity: number }> = {}
): CanvasElement {
  return {
    id,
...
export const viewElements: CanvasElement[] = [
  ...
  textEl('desc_welcome', 'Select or create a vault to begin', 140, 160, {
    fontSize: 14,
    fill: '#6b7280',
  }),
  rect('btn_open_vault', 160, 220, 160, 40, '#dc2626', { radius: 6 }),
  textEl('lbl_open_vault', 'Open Vault', 200, 230, {
    fontSize: 14,
    fontWeight: 600,
    fill: '#ffffff',
  }),
  ...
  textEl('lbl_toolbar', 'Toolbar: New | Delete | Theme | Settings', 870, 72, {
    fontSize: 11,
    fill: '#6b7280',
  }),
  ...
  textEl('lbl_canvas_tb', 'Canvas Toolbar: Select | Rect | Text | Frame | Component', 600, 740, {
    fontSize: 11,
    fill: '#6b7280',
  }),
  ...
  textEl('lbl_settings_tabs', 'General | Editor | Appearance | Vault | Hotkeys | About', 60, 1000, {
    fontSize: 11,
    fill: '#6b7280',
    width: 400,
  }),
  ...
  textEl(
    ...
    1648,
    130,
    { fontSize: 13, fill: '#374151', width: 300 }
  ),
];
...
export const componentElements: CanvasElement[] = [
  ...
  textEl('comp_fmt_lbl', 'B  I  S  </>  |  H  "  •  1.  |  link  table', 36, 266, {
    fontSize: 14,
    fill: '#6b7280',
    width: 420,
  }),
  textEl(
    'comp_fmt_desc',
    'Rich text formatting — bold, italic, strikethrough, code, headings, lists, links, tables',
    16,
    300,
    { fontSize: 11, fill: '#9ca3af', width: 460 }
  ),
  ...
  textEl('comp_si_desc', 'Milliseconds before auto-saving', 16, 436, {
    fontSize: 11,
    fill: '#9ca3af',
    width: 200,
  }),
...
export const tokenElements: CanvasElement[] = [
  ...
  textEl('tok_col_hover', '--interactive-accent-hover: #b91c1c', 68, 150, {
    fontSize: 12,
    width: 280,
  }),
  ...
  textEl('tok_col_surface', '--background-secondary: #f3f4f6', 68, 250, {
    fontSize: 12,
    width: 280,
  }),
