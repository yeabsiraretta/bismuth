...
const flowLinks: FlowLink[] = [
  ...
  {
    id: 'fl_ob_1_2',
    fromFrameId: 'flow_onboard_1',
    toFrameId: 'flow_onboard_2',
    transition: { type: 'dissolve', duration: 300 },
    label: 'No vault',
  },
  {
    id: 'fl_ob_2_3',
    fromFrameId: 'flow_onboard_2',
    toFrameId: 'flow_onboard_3',
    transition: { type: 'dissolve', duration: 300 },
    label: 'Vault opened',
  },
  // Edit flow
  {
    id: 'fl_ed_1_2',
    fromFrameId: 'flow_edit_1',
    toFrameId: 'flow_edit_2',
    transition: { type: 'instant', duration: 0 },
    label: 'Click',
  },
  {
    id: 'fl_ed_2_3',
    fromFrameId: 'flow_edit_2',
    toFrameId: 'flow_edit_3',
    transition: { type: 'instant', duration: 0 },
    label: 'Type',
  },
  // Canvas flow
  {
    id: 'fl_cv_1_2',
    fromFrameId: 'flow_canvas_1',
    toFrameId: 'flow_canvas_2',
    transition: { type: 'slide-right', duration: 300 },
  },
  {
    id: 'fl_cv_2_3',
    fromFrameId: 'flow_canvas_2',
    toFrameId: 'flow_canvas_3',
    transition: { type: 'instant', duration: 0 },
    label: 'Save',
  },
  // MCP flow
  {
    id: 'fl_mcp_1_2',
    fromFrameId: 'flow_mcp_1',
    toFrameId: 'flow_mcp_2',
    transition: { type: 'instant', duration: 0 },
    label: 'HTTP',
  },
  {
    id: 'fl_mcp_2_3',
    fromFrameId: 'flow_mcp_2',
    toFrameId: 'flow_mcp_3',
    transition: { type: 'instant', duration: 0 },
    label: 'Response',
  },
  // View navigation (page_views)
  {
    id: 'fl_welcome_editor',
    fromFrameId: 'frm_welcome',
    toFrameId: 'frm_editor',
    transition: { type: 'slide-right', duration: 300 },
    label: 'Open vault',
  },
  {
    id: 'fl_editor_graph',
    fromFrameId: 'frm_editor',
    toFrameId: 'frm_graph',
  ...
  },
  {
    id: 'fl_editor_canvas',
    fromFrameId: 'frm_editor',
    toFrameId: 'frm_canvas',
    transition: { type: 'slide-right', duration: 300 },
    label: 'Canvas btn',
  },
  {
    id: 'fl_editor_settings',
    fromFrameId: 'frm_editor',
    toFrameId: 'frm_settings',
    transition: { type: 'dissolve', duration: 200 },
    label: 'Cmd+,',
  },
  {
...
const variables: CanvasVariable[] = [
  {
    ...
    collection: 'Colors',
    type: 'color',
    values: { Light: '#dc2626', Dark: '#ef4444' },
    scopes: ['fill', 'stroke'],
  },
  {
    id: 'var_accent_hover',
    ...
    collection: 'Colors',
    type: 'color',
    values: { Light: '#b91c1c', Dark: '#f87171' },
    scopes: ['fill'],
  },
  {
    id: 'var_bg_primary',
    ...
    collection: 'Colors',
    type: 'color',
    values: { Light: '#ffffff', Dark: '#1e1e1e' },
    scopes: ['fill'],
  },
  {
    id: 'var_bg_secondary',
    ...
    collection: 'Colors',
    type: 'color',
    values: { Light: '#f3f4f6', Dark: '#252525' },
    scopes: ['fill'],
  },
  {
    id: 'var_text_normal',
    ...
    collection: 'Colors',
    type: 'color',
    values: { Light: '#1f2937', Dark: '#dcddde' },
    scopes: ['text'],
  },
  {
    id: 'var_text_muted',
    ...
    collection: 'Colors',
    type: 'color',
    values: { Light: '#6b7280', Dark: '#999999' },
    scopes: ['text'],
  },
  {
    id: 'var_border',
