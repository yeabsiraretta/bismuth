...
import * as componentService from '@/services/canvas/components';
...
/** Gets a component definition by ID from the current store state. */
...
// Re-export edit mode functions from split module
export {
  enterComponentEditMode,
  exitComponentEditMode,
  deleteComponentWithDetach,
} from './componentEditMode';
