...
const TASK_CHAR: Record<TaskState, string> = {
  open: ' ', done: 'x', inprogress: '/', onhold: '>', cancelled: '-',
};
...
const TASK_META: Record<TaskState, { label: string; cls: string; path: string }> = {
  ...
  cancelled:  { label: 'Cancelled', cls: 'cm-task-cancelled', path: 'M3 3h18v18H3zM9 9l6 6m0-6-6 6' },
};
...
export class CheckboxWidget extends WidgetType {
  constructor(private state: TaskState, private pos: number) { super(); }
  ...
  eq(other: CheckboxWidget) { return this.state === other.state && this.pos === other.pos; }
}
...
const CALLOUT_META: Record<string, { icon: string; color: string; label: string }> = {
  note:      { icon: 'M12 20h9M16.5 3.5a2.12 2.12 0 0 1 3 3L7 19l-4 1 1-4Z', color: '#448aff', label: 'Note' },
  info:      { icon: 'M12 2a10 10 0 1 0 0 20 10 10 0 0 0 0-20Zm0 5v2m0 4h.01', color: '#448aff', label: 'Info' },
  tip:       { icon: 'M12 2a7 7 0 0 0-4 12.7V17h8v-2.3A7 7 0 0 0 12 2ZM10 21h4', color: '#00bfa5', label: 'Tip' },
  hint:      { icon: 'M12 2a7 7 0 0 0-4 12.7V17h8v-2.3A7 7 0 0 0 12 2ZM10 21h4', color: '#00bfa5', label: 'Hint' },
  important: { icon: 'M12 2a10 10 0 1 0 0 20 10 10 0 0 0 0-20Zm0 5v6m0 4h.01', color: '#a855f7', label: 'Important' },
  success:   { icon: 'M22 11.08V12a10 10 0 1 1-5.93-9.14M22 4 12 14.01l-3-3', color: '#00c853', label: 'Success' },
  check:     { icon: 'M22 11.08V12a10 10 0 1 1-5.93-9.14M22 4 12 14.01l-3-3', color: '#00c853', label: 'Check' },
  question:  { icon: 'M12 2a10 10 0 1 0 0 20 10 10 0 0 0 0-20Zm0 14h.01M9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3', color: '#64b5f6', label: 'Question' },
  faq:       { icon: 'M12 2a10 10 0 1 0 0 20 10 10 0 0 0 0-20Zm0 14h.01M9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3', color: '#64b5f6', label: 'FAQ' },
  warning:   { icon: 'M10.29 3.86 1.82 18a2 2 0 0 0 1.71 3h16.94a2 2 0 0 0 1.71-3L13.71 3.86a2 2 0 0 0-3.42 0ZM12 9v4m0 4h.01', color: '#ff9100', label: 'Warning' },
  caution:   { icon: 'M10.29 3.86 1.82 18a2 2 0 0 0 1.71 3h16.94a2 2 0 0 0 1.71-3L13.71 3.86a2 2 0 0 0-3.42 0ZM12 9v4m0 4h.01', color: '#ff9100', label: 'Caution' },
  attention: { icon: 'M10.29 3.86 1.82 18a2 2 0 0 0 1.71 3h16.94a2 2 0 0 0 1.71-3L13.71 3.86a2 2 0 0 0-3.42 0ZM12 9v4m0 4h.01', color: '#ff9100', label: 'Attention' },
  danger:    { icon: 'M13 3a1 1 0 0 0-2 0 1 1 0 0 0 2 0ZM12 8v8m0 4h.01', color: '#ff1744', label: 'Danger' },
  error:     { icon: 'M12 2a10 10 0 1 0 0 20 10 10 0 0 0 0-20Zm4.93 14.93L8.46 8.46m0 8.47 8.47-8.47', color: '#ff1744', label: 'Error' },
  failure:   { icon: 'M12 2a10 10 0 1 0 0 20 10 10 0 0 0 0-20Zm4.93 14.93L8.46 8.46m0 8.47 8.47-8.47', color: '#ff1744', label: 'Failure' },
  bug:       { icon: 'M8 2l1.88 1.88M14.12 3.88 16 2M9 7.13v-1a3.003 3.003 0 1 1 6 0v1M12 20c-3.3 0-6-2.7-6-6v-3a6 6 0 0 1 12 0v3c0 3.3-2.7 6-6 6ZM12 20v-9M6.53 9C4.6 8.8 3 7.1 3 5m17.53 4c1.93-.2 3.53-1.9 3.53-4M6 13H2m20 0h-4', color: '#ff1744', label: 'Bug' },
  example:   { icon: 'M4 6h16M4 12h16M4 18h7', color: '#7c4dff', label: 'Example' },
  quote:     { icon: 'M3 21c3 0 7-1 7-8V5c0-1.25-.76-2.017-2-2H4c-1.25 0-2 .75-2 1.972V11c0 1.25.75 2 2 2 1 0 1 0 1 1v1c0 1-1 2-2 2s-1 .008-1 1.031V21ZM15 21c3 0 7-1 7-8V5c0-1.25-.757-2-2-2h-4c-1.25 0-2 .75-2 1.972V11c0 1.25.75 2 2 2h.75c0 2.25.25 4-2.75 4v3c0 1 0 1 1 1Z', color: '#9e9e9e', label: 'Quote' },
  cite:      { icon: 'M3 21c3 0 7-1 7-8V5c0-1.25-.76-2.017-2-2H4c-1.25 0-2 .75-2 1.972V11c0 1.25.75 2 2 2 1 0 1 0 1 1v1c0 1-1 2-2 2s-1 .008-1 1.031V21ZM15 21c3 0 7-1 7-8V5c0-1.25-.757-2-2-2h-4c-1.25 0-2 .75-2 1.972V11c0 1.25.75 2 2 2h.75c0 2.25.25 4-2.75 4v3c0 1 0 1 1 1Z', color: '#9e9e9e', label: 'Cite' },
  ...
  todo:      { icon: 'M22 11.08V12a10 10 0 1 1-5.93-9.14M22 4 12 14.01l-3-3', color: '#00b0ff', label: 'Todo' },
};
