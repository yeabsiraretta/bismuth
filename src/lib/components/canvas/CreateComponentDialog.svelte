<script lang="ts">
  ...
  function handleConfirm() {
    ...
    dispatch('confirm', { name: componentName.trim(), category: componentCategory.trim() });
    reset();
  }
...
{#if show}
  <div class="dialog-overlay" on:click={handleCancel} on:keydown={handleKeydown} role="presentation">
    <div class="dialog" on:click|stopPropagation role="dialog" aria-labelledby="create-comp-title">
