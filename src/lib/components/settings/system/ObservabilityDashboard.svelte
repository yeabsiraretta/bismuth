...
<div class="settings-section stack stack-md">
  ...
  <div class="overview-strip">
    <div
      class="overview-card"
      style="border-color: {health ? statusColor(health.overall) : 'var(--border-color)'}"
    >
      <span class="overview-label">Status</span>
      <span class="overview-value" style="color: {health ? statusColor(health.overall) : 'inherit'}"
        >{health?.overall ?? '...'}</span
      >
    </div>
    ...
    <div class="overview-card">
      ...
      <span
        ...
        style="color: {logCounts.warn > 0 ? 'var(--text-warning, #f59e0b)' : 'inherit'}"
        >{logCounts.warn}</span
      >
    </div>
    <div class="overview-card">
      ...
      <span
        class="overview-value"
        style="color: {logCounts.error > 0 ? 'var(--text-error, #ef4444)' : 'inherit'}"
