    ...
    captureState.update((s) => {
      ...
      if (isBatch && s.batchIndex < s.batchPaths.length - 1) {
        return {
          ...
          notePath: s.batchPaths[s.batchIndex + 1],
          values: {},
        };
      }
    ...
    <div class="capture-modal">
      ...
      <div class="capture-body">
        ...
        {:else if currentDef.type === 'number'}
          <input
            ...
            min={currentDef.constraints?.min}
            max={currentDef.constraints?.max}
      ...
      <div class="capture-footer">
        <button
          class="nav-btn"
          on:click={prev}
          disabled={state.currentIndex === 0 && state.batchIndex === 0}
        >
