    ...
    <div class="settings-area">
      ...
      <div class="setting-row">
        ...
        <div class="chip-row">
          <FilterChip
            label="File"
            active={$checklistConfig.groupBy === 'file'}
            on:click={() => setGroupBy('file')}
          />
          <FilterChip
            label="Tag"
            active={$checklistConfig.groupBy === 'tag'}
            on:click={() => setGroupBy('tag')}
          />
          <FilterChip
            label="Priority"
            active={$checklistConfig.groupBy === 'priority'}
            on:click={() => setGroupBy('priority')}
          />
          <FilterChip
            label="None"
            active={$checklistConfig.groupBy === 'none'}
      ...
      <div class="setting-row">
        ...
        <div class="chip-row">
          <FilterChip
            label="Oldest"
            active={$checklistConfig.sort === 'oldest'}
            on:click={() => setSort('oldest')}
          />
          <FilterChip
            label="Newest"
            active={$checklistConfig.sort === 'newest'}
            on:click={() => setSort('newest')}
          />
          <FilterChip
            label="Priority"
            active={$checklistConfig.sort === 'priority'}
            on:click={() => setSort('priority')}
          />
          <FilterChip
            label="A-Z"
            active={$checklistConfig.sort === 'alphabetical'}
