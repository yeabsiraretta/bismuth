...
export function computeBoundingBox(elements: CanvasElement[]): { minX: number; minY: number; maxX: number; maxY: number } {
...
export function buildGroupElement(elementsToGroup: CanvasElement[], childIds: string[]): CanvasElement {
...
export function normalizeElementPositions(elements: CanvasElement[], minX: number, minY: number): CanvasElement[] {
