...
<style>
  .mini-cal { border: 1px solid var(--border-color); border-radius: 8px; padding: 8px; }
  ...
  .cal-nav:hover { background: var(--hover-bg); color: var(--text-primary); }
  .cal-month { font-size: 11px; font-weight: 600; color: var(--text-primary); }
  ...
  .cal-cell {
    text-align: center; padding: 2px 0; font-size: 10px; border-radius: 4px;
    cursor: pointer; border: none; background: none; color: var(--text-primary);
    display: flex; flex-direction: column; align-items: center; justify-content: center;
    gap: 1px; aspect-ratio: 1; position: relative;
  }
  .cal-cell.empty { cursor: default; }
  .cal-cell:not(.empty):hover { background: var(--hover-bg); }
  .cal-cell.today { font-weight: 700; color: var(--interactive-accent); border: 1px solid var(--interactive-accent); }
  .cal-cell.selected { background: var(--interactive-accent); color: var(--text-on-accent, #fff); font-weight: 600; }
  .cal-cell.selected .cal-dot { background: var(--text-on-accent, #fff); }
