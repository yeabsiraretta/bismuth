...
// Types
export type {
  PrefixConfig, MarginAlignment, MarginDirection, MarginNote,
  ExplorerTab, ExplorerGrouping, ExplorerState, FlashcardEntry,
  MarginaliaSettings,
} from './types';

export { DEFAULT_PREFIXES, DEFAULT_MARGINALIA_SETTINGS, MARGIN_ANY_RE, MARGIN_IMG_RE, BLUR_SUFFIX_RE } from './types';
...
export {
  ...
  parseMultipleFiles, groupByColor, groupByFile,
...
// Stores
export {
  marginaliaSettings, currentNotes, vaultNotes, activeRecall,
  explorerState, filteredNotes, groupedNotes, noteCount, blurCount,
  parseCurrentNote, scanVaultNotes, toggleActiveRecall,
  setExplorerTab, setExplorerGrouping, setExplorerSearch, toggleGroup,
  setAlignment, setMarginWidth, setFontSize, setFontFamily,
  toggleReadingView, updatePrefix, addPrefix, removePrefix,
  setDefaultDirection, setLastCaptureDestination,
