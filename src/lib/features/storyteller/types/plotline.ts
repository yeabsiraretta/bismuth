...
export const BUILTIN_BEAT_SHEETS: BeatSheet[] = [
    ...
    beats: [
      {
        id: 'opening',
        name: 'Opening Image',
        description: 'Visual snapshot of the world before the story begins',
        act: 1,
        sortOrder: 0,
      },
      {
      ...
      },
      {
        id: 'theme',
        name: 'Theme Stated',
        description: 'Someone states the theme, often to the protagonist',
        act: 1,
        sortOrder: 2,
      },
      {
        id: 'catalyst',
        name: 'Catalyst',
        description: 'The inciting incident that changes everything',
        act: 1,
        sortOrder: 3,
      },
      {
        id: 'debate',
        name: 'Debate',
        description: 'Protagonist wrestles with the call to action',
        act: 1,
        sortOrder: 4,
      },
      {
        id: 'break2',
        name: 'Break into Two',
        description: 'Protagonist commits and enters the new world',
        act: 2,
        sortOrder: 5,
      },
      {
        id: 'bstory',
        name: 'B Story',
        description: 'A subplot (often love) that carries the theme',
        act: 2,
        sortOrder: 6,
      },
      {
      ...
      },
      {
        id: 'midpoint',
        name: 'Midpoint',
        description: 'False victory or false defeat raises the stakes',
        act: 2,
        sortOrder: 8,
      },
      {
        ...
        description: 'Opposition regroups and internal doubts surface',
        act: 2,
        sortOrder: 9,
      },
      {
      ...
      },
      {
        ...
        description: 'Moment of despair before the breakthrough',
        act: 2,
        sortOrder: 11,
      },
      {
        ...
        description: 'Protagonist finds the solution using A + B story lessons',
        act: 3,
        sortOrder: 12,
      },
      {
        id: 'finale',
        name: 'Finale',
        description: 'Protagonist executes the plan and transforms',
        act: 3,
        sortOrder: 13,
      },
      {
        id: 'closing',
        name: 'Final Image',
        description: 'Mirror of the opening — proof of change',
        act: 3,
        sortOrder: 14,
      },
    ],
  },
  {
    ...
    beats: [
      { id: 'hook', name: 'Hook', description: 'Grab the reader', act: 1, sortOrder: 0 },
      {
        ...
        description: 'Event that sets the plot in motion',
        act: 1,
        sortOrder: 1,
      },
      {
      ...
      },
      {
        id: 'rising',
        name: 'Rising Action',
        description: 'Escalating conflict and stakes',
        act: 2,
        sortOrder: 3,
      },
      {
      ...
      { id: 'crisis', name: 'Crisis', description: 'Darkest moment', act: 2, sortOrder: 5 },
      {
        ...
        description: 'Final piece falls into place',
        act: 2,
        sortOrder: 6,
      },
    ...
    beats: [
      {
        id: 'ordinary',
        name: 'Ordinary World',
        description: 'The hero in their normal life',
        act: 1,
        sortOrder: 0,
      },
      {
      ...
      },
      {
        ...
        description: 'Hero hesitates or declines',
        act: 1,
        sortOrder: 2,
      },
      {
        ...
        description: 'Guide or tool appears',
        act: 1,
        sortOrder: 3,
      },
      {
      ...
      },
      {
        ...
        description: 'Preparing for the ordeal',
        act: 2,
        sortOrder: 6,
      },
      {
        id: 'ordeal',
        name: 'The Ordeal',
        description: 'The greatest challenge',
        act: 2,
        sortOrder: 7,
      },
      { id: 'reward', name: 'Reward', description: 'Hero seizes the prize', act: 2, sortOrder: 8 },
      {
        id: 'road-back',
        name: 'The Road Back',
        description: 'Hero starts the return journey',
        act: 3,
        sortOrder: 9,
      },
      {
      ...
      },
      {
        ...
        description: 'Hero returns home changed',
        act: 3,
        sortOrder: 11,
      },
    ],
  ...
  {
    id: 'story-circle',
    template: 'story-circle',
    name: 'Story Circle (Dan Harmon)',
    beats: [
      {
        id: 'you',
        name: 'You (Comfort Zone)',
        description: 'Character in their world',
        act: 1,
        sortOrder: 0,
      },
      {
      ...
      },
      {
        id: 'go',
        name: 'Go (Unfamiliar)',
        description: 'Character enters a new situation',
        act: 2,
        sortOrder: 2,
      },
      {
        id: 'search',
        name: 'Search (Adapt)',
        description: 'Character struggles and adapts',
        act: 2,
        sortOrder: 3,
      },
      {
      ...
      },
      {
        id: 'take',
        name: 'Take (Price)',
        description: 'Character pays a heavy cost',
        act: 3,
        sortOrder: 5,
      },
      {
        id: 'return',
        name: 'Return (Go Back)',
        description: 'Character returns to the familiar',
        act: 3,
        sortOrder: 6,
      },
      {
        id: 'change',
        name: 'Change (Growth)',
        description: 'Character is fundamentally changed',
        act: 3,
        sortOrder: 7,
      },
    ],
