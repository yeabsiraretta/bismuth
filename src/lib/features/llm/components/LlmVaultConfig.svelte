    ...
    {#if config.restApiEnabled}
      <div class="port-row">
        ...
        <input
          ...
          on:change={() => { if (validatePort(config.restApiPort)) saveConfig(); }}
        />
...
<style>
  .llm-vault-config { display: flex; flex-direction: column; gap: var(--spacing-m); padding: var(--spacing-m); }
  .config-title { font-size: var(--font-ui-medium); font-weight: 600; color: var(--text-normal); margin: 0; }
  .warning-banner { display: flex; align-items: flex-start; gap: var(--spacing-s); padding: var(--spacing-s) var(--spacing-m); background: #fef3c7; border: 1px solid #f59e0b; border-radius: var(--radius-s); }
  .warning-icon { font-weight: 700; color: #b45309; flex-shrink: 0; font-size: var(--font-ui-small); }
  .warning-text { font-size: var(--font-ui-smaller); color: #92400e; line-height: 1.4; }
  .config-section { display: flex; flex-direction: column; gap: var(--spacing-s); padding: var(--spacing-s) 0; border-bottom: 1px solid var(--background-modifier-border); }
  .config-section:last-of-type { border-bottom: none; }
  .toggle-row { display: flex; align-items: center; justify-content: space-between; gap: var(--spacing-m); }
  .toggle-label { display: flex; flex-direction: column; gap: 2px; cursor: pointer; flex: 1; }
  .toggle-name { font-size: var(--font-ui-small); color: var(--text-normal); font-weight: 500; }
  .toggle-desc { font-size: var(--font-ui-smaller); color: var(--text-muted); line-height: 1.3; }
  .toggle-input { width: 36px; height: 20px; accent-color: var(--interactive-accent); cursor: pointer; flex-shrink: 0; }
  .port-row { display: flex; align-items: center; gap: var(--spacing-s); padding-left: var(--spacing-m); }
  .port-label { font-size: var(--font-ui-small); color: var(--text-muted); }
  .port-input { width: 90px; padding: var(--spacing-xs) var(--spacing-s); background: var(--background-secondary); border: 1px solid var(--background-modifier-border); border-radius: var(--radius-s); color: var(--text-normal); font-size: var(--font-ui-small); }
  .port-error { font-size: var(--font-ui-smaller); color: var(--text-error); }
  .save-error { font-size: var(--font-ui-smaller); color: var(--text-error); padding: var(--spacing-xs); background: var(--background-modifier-error); border-radius: var(--radius-s); }
  .save-success { font-size: var(--font-ui-smaller); color: var(--text-success, #065f46); padding: var(--spacing-xs); background: var(--background-modifier-success, #d1fae5); border-radius: var(--radius-s); }
  .prompt-row { display: flex; flex-direction: column; gap: var(--spacing-xs); }
  .prompt-input {
    width: 100%;
  ...
  .prompt-input:focus { border-color: var(--interactive-accent); outline: none; }
</style>
