...
// Types
export type {
  RootPathMode, AttachmentConfig, AttachmentOverride,
  OriginalNameEntry, AttachmentPathContext, RearrangeResult,
} from './types';
...
// Services — rearrange
export {
  extractAttachmentLinks, resolveLink,
  rearrangeNoteAttachments, rearrangeAllAttachments,
