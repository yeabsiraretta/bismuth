...
vi.mock('../services/courseService', () => {
  ...
  const mockTopics = [
    ...
    { notePath: 'Courses/AWS/t2.md', mastered: true,  lastReviewed: '2026-01-01T00:00:00Z', cardCount: 2 },
  ];
  return {
...
describe('courseStore', () => {
  ...
  it('saveCourseAction adds new course', async () => {
    const newCourse: Course = {
      id: 'c-2', name: 'Azure 900', subject: 'Cloud',
      examDate: null, totalTopics: 5, folderPath: 'Courses/Azure',
      status: 'active', createdAt: '2026-01-01T00:00:00Z', modifiedAt: '2026-01-01T00:00:00Z',
    };
