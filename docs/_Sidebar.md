...
- [Canvas System](architecture/bismuth-canvas-system.md)
...
- [Tailwind CSS](guides/tailwind-integration.md)
- [Dev Scripts](guides/development-scripts.md)

## Standards

- [Design System](standards/design-system.md)
- [Design Quick Ref](standards/design-system-quick-reference.md)
- [Design Principles](standards/design-principles.md)
- [UX Principles](standards/ux-principles.md)
...
- [Backlinks](reference/backlinks-implementation.md)
- [Graph View](reference/graph-view-implementation.md)
- [MVP Checklist](reference/mvp-checklist.md)

## Specifications

- [001 — PKM Editor MVP](../specs/001-bismuth-pkm-editor/)
- [002 — Canvas Design](../specs/002-canvas-component-design/)
- [003 — UI/UX Overhaul](../specs/003-ui-ux-overhaul/)
- [004 — Component System](../specs/004-canvas-component-system/)
